...
function getHighestOfTwoScores(score1, score2) {
  const score1Percent = Math.round((score1.received / score1.max) * 100);
  const score2Percent = Math.round((score2.received / score2.max) * 100);

  return Math.max(score1Percent, score2Percent);
}
