 ...
 */
const getPercentageScore = (score) => Number(((score.received / score.max) * 100).toFixed());
 ...
 */
const getHighestOfTwoScores = (score1, score2) => getPercentageScore(score1) > getPercentageScore(score2) ? getPercentageScore(score1) : getPercentageScore(score2);
